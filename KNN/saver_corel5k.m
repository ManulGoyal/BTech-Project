...
datasetsCap = {'corel5k'};
datasets = {'corel5k'};
test_image_count = [499];
train_image_count = [4500];
dict_size = [260];
%17495
%1957
...
iaprtc12_test_annot = double(vec_read(['../data/' datasetsCap{ids} '/' datasets{ids} '_test_annot.hvecs']));
iaprtc12_train_annot = double(vec_read(['../data/' datasetsCap{ids} '/' datasets{ids} '_train_annot.hvecs']));
...
distf = load(['../data/' datasetsCap{ids} '/' datasets{ids} '_distances.mat']);
